...
#define KC_QMAC QWERTY_MAC
#define KC_QPC  QWERTY_PC
...
QWERTY_PC
 */
  [_QWERTY_PC] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
     GRV ,  1 ,  2  , 3  , 4  , 5 , SPC,      SPC, 6  , 7  , 8  , 9  , 0  ,BSPC,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     TAB ,  Q ,  W  , E  , R  , T , SPC,      SPC, Y  , U  , I  , O  , P  ,LBRC,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     ESC ,  A ,  S ,  D , F  , G  , SPC,      SPC, H  , J  , K  , L  ,SCLN,QUOT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LSFT,  Z ,  X , C  , V  , B  , SPC,      SPC, N  , M  ,COMM,DOT ,SLSH,HOME,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGDN,LCTL,LALT,LGUI,LOWR,SPC ,LSFT,     ENT , F,  L, LEFT,DOWN, UP ,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY_MAC] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
     QPC , GRV , 1  , 2  , 3  , 4  , 5  ,      6  , 7  , 8  , 9  , 0  ,BSPC,DEL ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     MINS,TAB , Q  , W  , E  , R  , T  ,      Y  , U  , I  , O  , P  ,LBRC,RBRC,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     EQL, ESC , A  , S  , D  , F  , X  ,      H  , J  , K  , L  ,SCLN,QUOT,ENT ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
  ...
  switch (keycode) {
    case QWERTY_PC:
      if (record->event.pressed) {
        persistent_default_layer_set(1UL<<_QWERTY_PC);
      }
      return false;
      break;
    case QWERTY_MAC:
      if (record->event.pressed) {
        persistent_default_layer_set(1UL<<_QWERTY_MAC);
      }
      return false;
      break;
    case LOWER:
